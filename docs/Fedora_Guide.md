# Fedora - Z Space Installation Guide

## Prerequisites
- Who wants to use Z Space on Fedora :)
...
### C. Install Z Space **Core** packages:

- **Install the following packages for Z Space** (`scottames/awww`, `solopasha/hyprland`, `atim/starship`):
```bash
...
Restart your computer to apply the changes and start using Z Space on Fedora!
