...
-- DO NOT EDIT THIS FILE, EDIT ~/zspace-control/hyprland-custom.lua INSTEAD
...
-- Rules for z.sh
zSpaceOpacityRule = hl.window_rule({
    name  = "opacity-z",
...
-- Rules for z.sh | scrolling layout
hl.window_rule({
    name = "z-left",
    match = { class = "seycmd" },
    scrolling_width = 0.6,
...
zSpaceOpacityRule:set_enabled(true) -- z.sh kitty opacity
