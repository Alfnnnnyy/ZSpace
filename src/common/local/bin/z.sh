...
# Main
Z_CLOCK_FONT_SIZE=${Z_CLOCK_FONT_SIZE:-10}
Z_GENERAL_FONT_SIZE=${Z_GENERAL_FONT_SIZE:-11}
Z_TERMINAL_FONT_SIZE=${Z_TERMINAL_FONT_SIZE:-14}
...
cmd() {
    spawn kitty --title "zcmd" --class "seycmd" -o font_size=$Z_TERMINAL_FONT_SIZE --hold fastfetch
    sleep 0.2
}
